...
class VirtualMachine(object):
    ...
    def run_code(self, code, f_globals=None, f_locals=None):
        ...
        if self.frame and self.frame.stack:  # pragma: no cover
            raise VirtualMachineError(
                "The data remains on the stack! %r" % self.frame.stack
            )
    ...
    def manage_block_stack(self, why):
        ...
        if why == "exception" and block.type in ["setup-except", "finally"]:
            ...
            # PyErr_Normalize_Exception here
            self.push(tb, value, exctype)
            why = None
            self.jump(block.handler)
            return why
    ...
    def run_frame(self, frame):
        ...
        while True:
            ...
            if why == "exception":
                # TODO: ceval calls PyTraceBack_Here, not sure what it does.
                pass
        ...
        # TODO: handle generator exception status
    ...
    def byte_LOAD_FAST(self, name):
        if name in self.frame.f_locals:
            ...
            raise UnboundLocalError(
                "local variable '%s' access before assignment" % name
            )
        self.push(val)
    ...
    def byte_LOAD_GLOBAL(self, name):
        ...
        if name in f.f_globals:
            ...
            raise NameError("global name '%s' is undefined" % name)
        self.push(val)
    ...
    def byte_RAISE_VARARGS(self, argc):
        ...
        if argc == 2:
            ...
            raise VirtualMachineError("RAISE_VARARGS with invalid argc %d" % argc)
